...
\begin{tikzpicture}[scale=0.75, every node/.style={transform shape},
  ...
  \node[srcnavy, left=3.2cm of agg.west, yshift=3.8cm] (newsapi) {NewsAPI (Breaking)};
  \node[srcnavy, below=0.35cm of newsapi]              (finnhub) {Finnhub (Company)};
  \node[srcnavy, below=0.35cm of finnhub]              (alphav)  {Alpha Vantage (Sentiment)};
  \node[srcnavy, below=0.35cm of alphav]               (media)   {MediaStack (Global)};
  \node[srcnavy, below=0.35cm of media]                (rss)     {RSS Feeds (Always-on)};
  \node[font=\scriptsize\sffamily\bfseries\color{navy!80!black}, above=0.3cm of newsapi] {News Intelligence (5)};

  % ── Market Data (bottom-left) ──
  \node[srcgreen, left=3.2cm of agg.west, yshift=-3.0cm] (nse)   {NSE (OHLCV)};
  \node[srcgreen, below=0.35cm of nse]                  (bse)   {BSE (Filings)};
  \node[srcgreen, below=0.35cm of bse]                  (groww) {Groww (Fundamentals)};
  \node[font=\scriptsize\sffamily\bfseries\color{green!80!black}, above=0.3cm of nse] {Market Data (3)};

  % ── Institutional (top-right) ──
  \node[srcorange, right=2.8cm of out.east, yshift=2.8cm] (fii)     {FII/DII Flows (NSDL)};
  \node[srcorange, below=0.35cm of fii]                   (insider) {Insider (SAST/PIT)};
  \node[srcorange, below=0.35cm of insider]               (sec)     {SEC / Corp Filings};
  \node[font=\scriptsize\sffamily\bfseries\color{orange!80!black}, above=0.3cm of fii] {Institutional (3)};

  % ── Global Intelligence (bottom-right) ──
  \node[srcred, right=2.8cm of out.east, yshift=-2.2cm] (world) {WorldMonitor (Indices)};
  \node[srcred, below=0.35cm of world]                   (macro) {FRED Macro (CPI/Yield)};
  \node[srcred, below=0.35cm of macro]                   (geo)   {Geopolitical Risk};
  \node[font=\scriptsize\sffamily\bfseries\color{red!70!black}, above=0.3cm of world] {Global Intelligence (3)};
